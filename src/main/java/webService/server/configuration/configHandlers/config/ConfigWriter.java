...
import webService.server.configuration.jsonUtilities.JsonWriter;
 ...
 * <p>
 * Estende {@link webService.client.configuration.configHandlers.config.ConfigData} per accedere alla mappa di configurazione ({@code configDataMap}),
