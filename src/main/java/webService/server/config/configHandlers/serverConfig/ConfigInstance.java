package webService.server.config.configHandlers.serverConfig;

import webService.server.config.jsonUtilities.JsonUtility;
import webService.server.config.jsonUtilities.recognisedWrappers.RecognisedFile;
...
public class ConfigInstance {
     ...
     * @throws webService.server.config.configExceptions.JsonStructureException se il file non contiene tutti i campi obbligatori
     */
