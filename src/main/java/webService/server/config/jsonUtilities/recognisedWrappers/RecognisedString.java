package webService.server.config.jsonUtilities.recognisedWrappers;
 ...
 * <p>
 * Implementa {@link webService.server.config.jsonUtilities.recognisedWrappers.RecognisedInput} per fornire accesso tipizzato al valore grezzo
