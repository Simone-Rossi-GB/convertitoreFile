package webService.configuration.configHandlers.config;

import webService.configuration.configExceptions.JsonStructureException;
 ...
 * <p>
 * Estende {@link configuration.configHandlers.config.ConfigData} e fornisce metodi statici per leggere valori specifici dalla mappa
