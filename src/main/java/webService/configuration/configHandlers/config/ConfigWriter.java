...
import webService.configuration.jsonUtilities.JsonWriter;
 ...
 * <p>
 * Estende {@link configuration.configHandlers.config.ConfigData} per accedere alla mappa di configurazione ({@code configDataMap}),
